...
class GUI:
    ...
    def btnStartClick(self):
        ...
        # m_thread.start()
        # m_thread.join()
        print("### 무조건 들어옵니다. flag :: ", self.processFlag)
    ...
    def btnShowLogClick(self):
        ...
        """
        print("로그폴더를 오픈합니다.")
        os.startfile('C:\DRxSolution\logs')
